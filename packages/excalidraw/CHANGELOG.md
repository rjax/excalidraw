...
- Update imports to use @rjax/excalidraw and add dimension handling features
...
- Add zoomStep to AppState and new API method for adding elements from paste or library
